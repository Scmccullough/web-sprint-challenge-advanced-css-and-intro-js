...
Making websites easy to use for everyone, including those with smaller screens and those who have impairment.
2. Talk about 3 different things you can do to ensure your website is accessible.
 Use appropriate labeling when constructing your HTML as to accommodate screen readers, use scalable units in your css, and add media queries to accommodate smaller devices.
3. How would you explain the concept of a variable to someone new to programming?
It is a way to store, change and use data in code.
4. What is the purpose of using functions in code?
To allow you to repeat sections of code with just a single line.
