...
function addArtist(array){
  array.push({ id:20 , name:'Samuel McCullough', years:'1994 - current day', genre:'Web Design', nationality:'American', bio:'Born in a small town in east TN, Samuel pursued a degree in Chemistry from the TTU before coming to Lambda.'});
  return array;
  }
